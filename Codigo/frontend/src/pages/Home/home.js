      ...
      <main>
              ...
              <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                  ...
                  <li>
                    <a
                      href="#"
                      className="nav-link text-black disabled"
                      style={{ display: displayNone }}
                    >
                      <svg
                        className="bi d-block mx-auto mb-1"
                  ...
                  <li>
                    ...
                    >
                      <svg
                        ...
                        height="24"
                      >
                        <use xlinkHref="#arrow-right-from-bracket"></use>
                      </svg>
                      Logout
                    </button>
                  </li>
        ...
        >
          <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center">
            <div className="col-md-5 p-lg-5 mx-auto my-5">
              ...
              <Link className="btn btn-outline-secondary" to='cadastro' style={{ display: displayVisible }}>
                Criar conta
              </Link>
            </div>
        ...
        <section id="motivos">
          <div className="d-md-flex flex-md-equal w-100 my-md-5 ps-md-5">
            <div className="text-bg me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              <div className="my-3 py-3">
                <h2 className="display-5">
                  <b>Dashboard de investimentos</b>
                </h2>
                <p className="lead">
                  Gráficos sobre o desempenho dos investimentos.
                </p>
            ...
            <div className="text-bg me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              ...
              >
                <img width="100%" src={contaMao} alt="Pessoa fazendo contas" />
              </div>
            </div>
          </div>
          <div className="d-md-flex flex-md-equal w-100 my-md-5 ps-md-5">
            <div className="text-bg me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              ...
              >
                <img width="100%" src={cadastroInvest} alt="Grafico de setas" />
              </div>
            </div>
            <div className="text-bg me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              <div className="my-3 p-3">
              ...
              >
                <img width="100%" src={relatorio} alt="Grafico de barras" />
              </div>
            </div>
          </div>
        </section>
      ...
      <footer id="rodape">
        <div className="row">
          <div className="col-lg-12" id="copyright">
            <p>
              <i className="far fa-copyright"></i> Copyright PUC MINAS 2023
            </p>
          </div>
        </div>
      </footer>
